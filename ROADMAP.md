...
- **Repères d'état des lieux visuel mal positionnés dans certains cas signalés par l'utilisateur** — testé et non reproduit sur la fiche Remise admin ni sur la page de signature réelle (repère posé au pixel exact du clic dans les deux cas, cf. tests manuels du 2026-08-04) ; à ré-investiguer avec une capture d'écran précise (point cliqué vs position obtenue) la prochaine fois que ça se reproduit — possiblement lié à un navigateur/zoom particulier.
