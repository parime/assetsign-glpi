...
| ~~Bénéfice du réemploi ("impact évité" : durée prévue vs réelle)~~ — **livré** (issue #81) : nouvelle section du Passeport matériel, calcul « évitement proportionnel » à partir de `Infocom::sink_time` (durée d'amortissement, en années) et de l'empreinte carbone de fabrication déjà saisie (issue #80) ; rien n'est affiché tant que la durée réelle n'a pas dépassé la durée prévue, ou si l'un des deux prérequis manque — jamais une moyenne inventée. Case à cocher dédiée, désactivée par défaut, même paramétrage que le passeport environnemental. | | | | | |
