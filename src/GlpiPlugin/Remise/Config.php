...
class Config extends CommonDBTM
{
   ...
   private const DEFAULTS = [
        ...
        'maintenance_signature_required'      => 0,
   ...
   public static function upsertForEntity(int $entities_id, array $input): void {
      ...
      foreach (self::getAllManageableItemtypes() as $itemtype) {
       ...
       $data = [
           ...
           'maintenance_signature_required' => (int) ($input['maintenance_signature_required'] ?? 0),
   ...
   public static function install(Migration $migration): void {
      ...
      if (!$DB->tableExists($table)) {
          ...
          $DB->doQuery("CREATE TABLE `$table` (
                ...
                `maintenance_signature_required` tinyint NOT NULL DEFAULT 0,
          ...
          $DB->insert($table, [
              ...
              'maintenance_signature_required' => self::DEFAULTS['maintenance_signature_required'],
              'sign_on_assignment' => 1,
              'sign_on_reassignment' => 1,
         ...
         if (!$DB->fieldExists($table, 'maintenance_signature_required')) {
             $migration->addField($table, 'maintenance_signature_required', 'bool', ['value' => 0, 'after' => 'enable_damage_annotation']);
             $migration->migrationOneTable($table);
         }
