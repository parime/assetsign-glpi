...
| V1 | Mouvements structurés (départ/destination/documents/signature) | [#75](https://github.com/parime/assetsign-glpi/issues/75) | Analysé (section 3.2), **non implémenté** - reste ouvert, schéma proposé documenté ci-dessus |
...
| V2 | Fin de vie structurée (vente/don/destruction) | [#78](https://github.com/parime/assetsign-glpi/issues/78) | Date de réforme automatique déjà livrée (2026-08-19) ; reste prestataire/certificat (destruction), organisme/justificatif (don) |
