...
**Outils > Fiches de maintenance** : la même logique, mais pour les fiches de maintenance internes (sans bénéficiaire, signature du technicien optionnelle selon la configuration) — un second point d'entrée vers la même liste que l'onglet Maintenance d'un matériel donné :
...
Un second onglet dédié, indépendant des remises signées (pas de bénéficiaire), avec le formulaire de nouvelle fiche de maintenance directement accessible — chaque point de contrôle affiche son propre type de saisie (case à cocher, champ texte, menu déroulant) tel que défini dans Intitulés. Si le réglage « Signature du technicien obligatoire » est activé (Configuration > Remise & signature > onglet Maintenance), un canevas de signature (souris, doigt ou stylet) apparaît en bas du formulaire et doit être rempli pour valider la fiche ; sinon, aucune signature n'est demandée et la fiche se crée directement :
...
- **Fiches de maintenance/préparation** : formulaire interne (sans bénéficiaire) avec une checklist de points de contrôle entièrement configurable par l'administrateur (Configuration > Intitulés) et un commentaire libre — accessible depuis l'onglet Maintenance de chaque matériel *et* directement depuis la liste des fiches (Outils > Fiches de maintenance > Nouvelle fiche, avec sélection du matériel). Chaque point de contrôle définit son propre **type de saisie** (case à cocher, texte libre, ou menu déroulant avec des options définies par l'administrateur) — pas seulement des cases à cocher. **État des lieux visuel disponible aussi sur ces fiches** (même réglage que ci-dessous) : les repères sont déposés au moment de la création (une fiche de maintenance est un constat figé, jamais modifiée après coup — contrairement à une remise, aucune fenêtre d'édition ultérieure n'est proposée), puis simplement affichés en lecture seule sur la fiche une fois créée. **Signature électronique du technicien optionnelle** (Configuration > Remise & signature > onglet Maintenance, case « Signature du technicien obligatoire ») : un seul réglage pilote à la fois l'affichage d'un canevas de signature (souris, doigt ou stylet) sur le formulaire de création et son caractère obligatoire — si coché, la fiche ne peut pas être validée sans signature ; si décoché, aucune signature n'est demandée. **Compte-rendu PDF généré automatiquement** dès la création de la fiche (logo de l'entité, matériel concerné, section "Contrôle réalisé par" avec le nom et l'e-mail du technicien qui a rempli la checklist, points de contrôle, état des lieux visuel, signature du technicien si recueillie, commentaire) — téléchargeable directement depuis la fiche ou depuis la liste des fiches de maintenance, sans avoir à ouvrir chaque fiche.
